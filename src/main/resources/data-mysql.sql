...
insert into question(id, description, field_name, `type`, option_id) values
    (1, '中心编号', 'centerId', 'IMMUTABLE', null),
    (2, '研究编号', 'surveyId', 'IMMUTABLE', null),
    (3, '出生日期', 'birth', 'DATE', 1),
    (4, '性别', 'gender', 'SINGLE_SELECT', 2),
    (5, '民族', 'ethnic', 'SINGLE_SELECT', 3),
    (6, '籍贯', 'birthPlace', 'LIST', null),
    (7, '职业', 'job', 'SINGLE_SELECT', 4),
    (8, '通讯地址', 'address', 'LIST', null),
    (9, '身高（单位：米）', 'height', 'NUMBER', 5),
    (10, '体重（单位：米）', 'weight', 'NUMBER', 6);
...
insert into question(id, description, field_name, `type`, option_id) values
    (100000, '男', 'gender_male', 'CHOICE', null),
    (100001, '女', 'gender_female', 'CHOICE', null),
    --
    (100002, '汉族', 'ethnic_han', 'CHOICE', 100000),
    (100003, '满族', 'ethnic_man', 'CHOICE', 100001),
    (100004, '蒙古族', 'ethnic_menggu', 'CHOICE', 100002),
    (100005, '回族', 'ethnic_hui', 'CHOICE', 100003),
    (100006, '藏族', 'ethnic_zang', 'CHOICE', 100004),
    (100007, '维吾尔族', 'ethnic_weiwuer', 'CHOICE', 100005),
    (100008, '苗族', 'ethnic_miao', 'CHOICE', 100006),
    (100009, '彝族', 'ethnic_yi', 'CHOICE', 100007),
    (100010, '壮族', 'ethnic_zhuang', 'CHOICE', 100008),
    (100011, '布依族', 'ethnic_buyi', 'CHOICE', 100009),
    (100012, '侗族', 'ethnic_dong', 'CHOICE', 100010),
    (100013, '瑶族', 'ethnic_yao', 'CHOICE', 100011),
    (100014, '白族', 'ethnic_bai', 'CHOICE', 100012),
    (100015, '土家族', 'ethnic_tujia', 'CHOICE', 100013),
    (100016, '哈尼族', 'ethnic_hani', 'CHOICE', 100014),
    (100017, '哈萨克族', 'ethnic_hasake', 'CHOICE', 100015),
    (100018, '傣族', 'ethnic_dai', 'CHOICE', 100016),
    (100019, '黎族', 'ethnic_li', 'CHOICE', 100017),
    (100020, '傈僳族', 'ethnic_lisu', 'CHOICE', 100018),
    (100021, '佤族', 'ethnic_wa', 'CHOICE', 100019),
    (100022, '畲族', 'ethnic_she', 'CHOICE', 100020),
    (100023, '高山族', 'ethnic_gaoshan', 'CHOICE', 100021),
    (100024, '拉祜族', 'ethnic_lahu', 'CHOICE', 100022),
    (100025, '水族', 'ethnic_shui', 'CHOICE', 100023),
    (100026, '东乡族', 'ethnic_dongxiang', 'CHOICE', 100024),
    (100027, '纳西族', 'ethnic_naxi', 'CHOICE', 100025),
    (100028, '景颇族', 'ethnic_jingpo', 'CHOICE', 100026),
    (100029, '柯尔克孜族', 'ethnic_keerkezi', 'CHOICE', 100027),
    (100030, '土族', 'ethnic_tu', 'CHOICE', 100028),
    (100031, '达斡尔族', 'ethnic_dawoer', 'CHOICE', 100029),
    (100032, '仫佬族', 'ethnic_mulao', 'CHOICE', 100030),
    (100033, '羌族', 'ethnic_qiang', 'CHOICE', 100031),
    (100034, '布朗族', 'ethnic_bulang', 'CHOICE', 100032),
    (100035, '撒拉族', 'ethnic_sala', 'CHOICE', 100033),
    (100036, '毛南族', 'ethnic_maonan', 'CHOICE', 100034),
    (100037, '仡佬族', 'ethnic_gelao', 'CHOICE', 100035),
    (100038, '锡伯族', 'ethnic_xibo', 'CHOICE', 100036),
    (100039, '阿昌族', 'ethnic_achang', 'CHOICE', 100037),
    (100040, '普米族', 'ethnic_pumi', 'CHOICE', 100038),
    (100041, '朝鲜族', 'ethnic_chaoxian', 'CHOICE', 100039),
    (100042, '塔吉克族', 'ethnic_tajike', 'CHOICE', 100040),
    (100043, '怒族', 'ethnic_nu', 'CHOICE', 100041),
    (100044, '乌孜别克族', 'ethnic_wuzibieke', 'CHOICE', 100042),
    (100045, '俄罗斯族', 'ethnic_eluosi', 'CHOICE', 100043),
    (100046, '鄂温克族', 'ethnic_ewenke', 'CHOICE', 100044),
    (100047, '德昂族', 'ethnic_deang', 'CHOICE', 100045),
    (100048, '保安族', 'ethnic_baoan', 'CHOICE', 100046),
    (100049, '裕固族', 'ethnic_yugu', 'CHOICE', 100047),
    (100050, '京族', 'ethnic_jing', 'CHOICE', 100048),
    (100051, '塔塔尔族', 'ethnic_tataer', 'CHOICE', 100049),
    (100052, '独龙族', 'ethnic_dulong', 'CHOICE', 100050),
    (100053, '鄂伦春族', 'ethnic_elunchun', 'CHOICE', 100051),
    (100054, '赫哲族', 'ethnic_hezhe', 'CHOICE', 100052),
    (100055, '门巴族', 'ethnic_menba', 'CHOICE', 100053),
    (100056, '珞巴族', 'ethnic_luoba', 'CHOICE', 100054),
    (100057, '基诺族', 'ethnic_jinuo', 'CHOICE', 100055),
    --
    (100058, '省', 'birthPlace_province', 'TEXT', 100056),
    (100059, '市', 'birthPlace_city', 'TEXT', 100057),
    (100060, '省', 'address_province', 'TEXT', 100058),
    (100061, '市', 'address_city', 'TEXT', 100059),
    (100062, '县', 'address_county', 'TEXT', 100060);
...
insert into question(id, description, field_name, `type`, option_id) values
    (100070, '腹痛', 'symptoms_stomachache', 'CHOICE', 100070),
    (100071, '腹胀', 'symptoms_bloating', 'CHOICE', 100070),
    (100072, '黄疸', 'symptoms_jaundice', 'CHOICE', 100070),
    (100073, '恶心呕吐', 'symptoms_vomit', 'CHOICE', 100070),
    (100074, '乏力纳差', 'symptoms_weakness', 'CHOICE', 100070),
    (100075, '消瘦', 'symptoms_emaciate', 'CHOICE', 100070),
    (100076, '发热', 'symptoms_fever', 'CHOICE', 100070),
    (100077, '其他', 'symptoms_other', 'CHOICE', 100070),
    -- 附带联动，病症持续时间
